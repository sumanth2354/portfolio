          ...
          <div className="space-y-8">
            <div>
              ...
              <p className="text-white/70 text-lg leading-relaxed">
                Developer with a strong interest in databases and API development, building reliable and user-friendly web applications with clean and maintainable code.
              </p>
            </div>
              ...
              <div className="relative pl-8 border-l-2 border-white/20">
                ...
                <div className="pb-8">
                  <div className="flex items-center justify-between mb-2">
                    ...
                    <span className="text-sm text-white/50">2023 - Present</span>
                  </div>
                  <p className="text-white/70">Information Technology</p>
                </div>
                ...
                <div className="pb-8">
                  <div className="flex items-center justify-between mb-2">
                    ...
                    <span className="text-sm text-white/50">2021 - 2023</span>
                  </div>
                  <p className="text-white/70">MPC</p>
                </div>
                ...
                <div>
                  <div className="flex items-center justify-between mb-2">
                    ...
                    <span className="text-sm text-white/50">2016 - 2021</span>
                  </div>
